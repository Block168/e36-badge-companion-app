          ...
          >
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1">
                <span className={cn("text-xs font-medium truncate", theme === "dark" ? "text-zinc-200" : "text-slate-700")}>
                  {log.faceName}
                </span>
                <StatusBadge status={log.status} />
              </div>
              <div className={cn("text-[10px]", theme === "dark" ? "text-zinc-500" : "text-slate-500")}>
